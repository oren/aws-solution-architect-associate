 ...
 */
export declare const PROTO_RESPONSE_VERSION = "0.14.0";
 ...
 */
export declare const DEFAULT_ACCOUNT_CONTEXT_KEY = "aws:cdk:toolkit:default-account";
/**
 * Context parameter for the default AWS region to use if a stack's environment is not set.
 */
export declare const DEFAULT_REGION_CONTEXT_KEY = "aws:cdk:toolkit:default-region";
